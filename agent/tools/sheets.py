...
# ---------------------------
def _resolve_class(gc_spreadsheet, class_id: str):
    """MVP: single source of truth for class resolution"""
...
def _get_class_progress(spreadsheet_id: str, class_id: str):
    ...
    class_id = _resolve_class(gc_spreadsheet, class_id)
...
def class_info(spreadsheet_id: str, class_id: str) -> list:
    ...
    return [
        _get_class_progress(spreadsheet_id, class_id),
        _get_assignments(spreadsheet_id, class_id)
    ]
